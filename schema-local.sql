...
DROP VIEW IF EXISTS v_assreqs; CREATE VIEW v_assreqs AS SELECT
    ...
    FROM v_groups g
    GROUP BY batch_id;
-- DROP TABLE IF EXISTS f2f_assessors; CREATE TABLE f2f_assessors (
--     [batch_id] INTEGER NOT NULL,
--     [assessor_id] INTEGER NOT NULL,
--     [slot1] TEXT,   -- group_id or person_id or NULL
--     [slot2] TEXT,   -- group_id or person_id or NULL
--     [slot3] TEXT,   -- group_id or person_id or NULL
--     [slot4] TEXT,   -- group_id or person_id or NULL
--     PRIMARY KEY (batch_id, assessor_id)
-- );
-- DROP VIEW IF EXISTS v_f2f_assessors; CREATE VIEW v_f2f_assessors AS SELECT
--     f.*, a.fullname
--     FROM f2f_assessors f
--     LEFT JOIN assessors a ON f.assessor_id=a.id;
